...
| 2.5 | payload completeness and numeric domain (FR16) | `ready-for-dev` (2026-08-12) — carries ADR 0031 to the source boundary; **implements no bounds**, FR16's `min/max` clause being what ADR 0033 withdrew |
